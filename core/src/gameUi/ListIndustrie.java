 ...
 * @author mzechner
 * @author Nathan Sweet */
public class ListIndustrie<T> extends Widget implements Cullable {
    ...
    public ListIndustrie (Skin skin) {
        this(skin.get(com.badlogic.gdx.scenes.scene2d.ui.List.ListStyle.class));
    }

    public ListIndustrie (Skin skin, String styleName) {
        this(skin.get(styleName, com.badlogic.gdx.scenes.scene2d.ui.List.ListStyle.class));
    }

    public ListIndustrie (com.badlogic.gdx.scenes.scene2d.ui.List.ListStyle style) {
        ...
        addListener(keyListener = new InputListener() {
            ...
            public boolean keyTyped (InputEvent event, char character) {
                ...
                for (int i = 0, n = items.size; i < n; i++) {
                    if (ListIndustrie.this.toString(items.get(i)).toLowerCase().startsWith(prefix)) {
                        setSelectedIndex(i);
                        break;
                    }
                }
        ...
        addListener(new InputListener() {
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setKeyboardFocus(ListIndustrie.this);
    ...
    /** Returns the list's style. Modifying the returned style may not have an effect until {@link #setStyle(com.badlogic.gdx.scenes.scene2d.ui.List.ListStyle)} is
     * called. */
    ...
    public int getItemIndexAt (float y) {
        ...
        Drawable background = ListIndustrie.this.style.background;
        if (background != null) {
